...
var calendarEl, today, mYear, weekday, mDay, m, d, calendar, allInputs, fixedPlugin, fixedPluginButton,
    fixedPluginButtonNav, fixedPluginCard, fixedPluginCloseButton, navbar, buttonNavbarFixed,
...
function navbarBlurOnScroll(e) {
    ...
    let n = ["blur", "shadow-blur", "left-auto"], i = ["shadow-none"];
...
function initNavs() {
    total.forEach(function (l, e) {
        var s = document.createElement("div"), t = l.querySelector("li:first-child .nav-link").cloneNode();
        ...
        s.style.padding = "0px", s.style.width = l.querySelector("li:nth-child(1)").offsetWidth + "px", s.style.transform = "translate3d(0px, 0px, 0px)", s.style.transition = ".5s ease", l.onmouseover = function (e) {
            ...
            if (i) {
                let a = Array.from(i.closest("ul").children), n = a.indexOf(i) + 1;
            ...
            if (!t.classList.contains("flex-column")) {
                ...
                var a = t.querySelector(".nav-link.active").parentElement, n = Array.from(a.closest("ul").children);
                n.indexOf(a);
                let e = 0;
                for (var i = 1; i <= n.indexOf(a); i++) e += t.querySelector("li:nth-child(" + i + ")").offsetHeight;
                var l = document.querySelector(".moving-tab");
                l.style.width = t.querySelector("li:nth-child(1)").offsetWidth + "px", l.style.transform = "translate3d(0px," + e + "px, 0px)"
            }
        })
    })
}
...
setTimeout(function () {
    ...
    total.forEach(function (t, e) {
        ...
        var a = document.createElement("div"), n = t.querySelector(".nav-link.active").cloneNode(),
            i = (n.innerHTML = "-", a.classList.add("moving-tab", "position-absolute", "nav-link"), a.appendChild(n), t.appendChild(a), a.style.padding = "0px", a.style.transition = ".5s ease", t.querySelector(".nav-link.active").parentElement);
        if (i) {
            var l = Array.from(i.closest("ul").children), n = l.indexOf(i) + 1;
            let e = 0;
            if (t.classList.contains("flex-column")) {
                for (var s = 1; s <= l.indexOf(i); s++) e += t.querySelector("li:nth-child(" + s + ")").offsetHeight;
                a.style.transform = "translate3d(0px," + e + "px, 0px)", a.style.width = t.querySelector("li:nth-child(" + n + ")").offsetWidth + "px", a.style.height = t.querySelector("li:nth-child(" + s + ")").offsetHeight
            } else {
                for (s = 1; s <= l.indexOf(i); s++) e += t.querySelector("li:nth-child(" + s + ")").offsetWidth;
                a.style.transform = "translate3d(" + e + "px, 0px, 0px)", a.style.width = t.querySelector("li:nth-child(" + n + ")").offsetWidth + "px"
            }
        }
    }), window.innerWidth < 991 ? total.forEach(function (t, e) {
        if (!t.classList.contains("flex-column")) {
        ...
        if (t.classList.contains("on-resize")) {
            ...
            var a = t.querySelector(".nav-link.active").parentElement, n = Array.from(a.closest("ul").children),
                i = n.indexOf(a) + 1;
            let e = 0;
            for (var l = 1; l <= n.indexOf(a); l++) e += t.querySelector("li:nth-child(" + l + ")").offsetWidth;
            var s = document.querySelector(".moving-tab");
            s.style.transform = "translate3d(" + e + "px, 0px, 0px)", s.style.width = t.querySelector("li:nth-child(" + i + ")").offsetWidth + "px"
        }
    })
...
const iconNavbarSidenav = document.getElementById("iconNavbarSidenav"),
    iconSidenav = document.getElementById("iconSidenav"), sidenav = document.getElementById("sidenav-main");
...
function notify(e) {
    var t = document.querySelector("body"), a = document.createElement("div");
...
function darkMode(e) {
    var t, a = document.getElementsByTagName("body")[0], n = document.querySelectorAll("div:not(.sidenav) > hr"),
        i = document.querySelector(".sidenav"), l = document.querySelectorAll(".sidenav.bg-white"),
        ...
        d = document.querySelectorAll("strong.text-dark"), u = document.querySelectorAll("strong.text-white"),
        g = document.querySelectorAll("a.nav-link.text-dark"), m = document.querySelectorAll(".text-secondary"),
        v = document.querySelectorAll(".text-white"), f = document.querySelectorAll(".bg-gray-100"),
        ...
        p = document.querySelectorAll(".card.border"), x = document.querySelectorAll(".card.border.border-dark"),
        w = document.querySelectorAll(".navbar g"), L = document.querySelector(".navbar-brand-img"), S = L.src,
    ...
    if (e.getAttribute("checked")) {
        a.classList.remove("dark-version"), i.classList.add("bg-white"), S.includes("logo-ct.png") && (t = S.replace("logo-ct", "logo-ct-dark"), L.src = t);
        for (E = 0; E < k.length; E++) k[E].classList.contains("text-dark") && (k[E].classList.add("text-white"), k[E].classList.remove("text-dark"));
        for (E = 0; E < q.length; E++) q[E].classList.contains("text-white") && (q[E].classList.remove("text-white"), q[E].classList.add("text-dark"));
        for (E = 0; E < A.length; E++) A[E].classList.contains("text-white") && A[E].classList.remove("text-white");
        for (E = 0; E < B.length; E++) B[E].classList.add("blur", "shadow-blur");
        for (E = 0; E < C.length; E++) C[E].classList.add("blur");
        for (E = 0; E < n.length; E++) n[E].classList.contains("light") && (n[E].classList.add("dark"), n[E].classList.remove("light"));
        for (E = 0; E < s.length; E++) s[E].classList.contains("light") && (s[E].classList.add("dark"), s[E].classList.remove("light"));
        for (E = 0; E < r.length; E++) r[E].classList.contains("text-white") && (r[E].classList.remove("text-white"), r[E].classList.add("text-dark"));
        for (E = 0; E < c.length; E++) !c[E].classList.contains("text-white") || c[E].closest(".sidenav") || c[E].closest(".card.bg-gradient-dark") || (c[E].classList.remove("text-white"), c[E].classList.add("text-dark"));
        for (E = 0; E < u.length; E++) u[E].classList.contains("text-white") && (u[E].classList.remove("text-white"), u[E].classList.add("text-dark"));
        for (E = 0; E < v.length; E++) v[E].classList.contains("text-white") && (v[E].classList.remove("text-white"), v[E].classList.remove("opacity-8"), v[E].classList.add("text-secondary"));
        for (E = 0; E < h.length; E++) h[E].classList.contains("bg-gray-600") && (h[E].classList.remove("bg-gray-600"), h[E].classList.add("bg-gray-100"));
        for (E = 0; E < w.length; E++) w[E].hasAttribute("fill") && w[E].setAttribute("fill", "#6c757d");
        for (E = 0; E < y.length; E++) y[E].closest(".card.bg-gradient-dark") || (y[E].classList.remove("text-white"), y[E].classList.add("text-dark"));
        ...
        for (var E = 0; E < B.length; E++) B[E].classList.contains("blur") && B[E].classList.remove("blur", "shadow-blur");
        for (var E = 0; E < k.length; E++) k[E].classList.contains("text-white") && k[E].classList.remove("text-white");
        for (var E = 0; E < C.length; E++) C[E].classList.contains("blur") && C[E].classList.remove("blur");
        for (var E = 0; E < q.length; E++) q[E].classList.contains("text-dark") && (q[E].classList.remove("text-dark"), q[E].classList.add("text-white"));
        for (var E = 0; E < A.length; E++) A[E].classList.contains("text-sm") && A[E].classList.add("text-white");
        for (var E = 0; E < n.length; E++) n[E].classList.contains("dark") && (n[E].classList.remove("dark"), n[E].classList.add("light"));
        for (var E = 0; E < s.length; E++) s[E].classList.contains("dark") && (s[E].classList.remove("dark"), s[E].classList.add("light"));
        for (var E = 0; E < r.length; E++) r[E].classList.contains("text-dark") && (r[E].classList.remove("text-dark"), r[E].classList.add("text-white"));
        for (var E = 0; E < o.length; E++) o[E].classList.contains("text-dark") && (o[E].classList.remove("text-dark"), o[E].classList.add("text-white"));
        for (var E = 0; E < d.length; E++) d[E].classList.contains("text-dark") && (d[E].classList.remove("text-dark"), d[E].classList.add("text-white"));
        for (var E = 0; E < g.length; E++) g[E].classList.contains("text-dark") && (g[E].classList.remove("text-dark"), g[E].classList.add("text-white"));
        for (var E = 0; E < m.length; E++) m[E].classList.contains("text-secondary") && (m[E].classList.remove("text-secondary"), m[E].classList.add("text-white"), m[E].classList.add("opacity-8"));
        for (var E = 0; E < f.length; E++) f[E].classList.contains("bg-gray-100") && (f[E].classList.remove("bg-gray-100"), f[E].classList.add("bg-gray-600"));
        for (var E = 0; E < b.length; E++) b[E].classList.remove("text-dark"), b[E].classList.add("text-white");
        for (var E = 0; E < l.length; E++) l[E].classList.remove("bg-white");
        for (var E = 0; E < w.length; E++) w[E].hasAttribute("fill") && w[E].setAttribute("fill", "#fff");
...
var soft = {
    initFullCalendar: function () {
        document.addEventListener("DOMContentLoaded", function () {
            var e = document.getElementById("fullCalendar"), t = new Date, a = t.getFullYear(), n = t.getMonth(),
                t = t.getDate(), i = new FullCalendar.Calendar(e, {
                    initialView: "dayGridMonth",
                    selectable: !0,
                    headerToolbar: {
                        left: "title",
                    ...
                    select: function (a) {
                        Swal.fire({
                            ...
                            t && (t = {title: t, start: a.startStr, end: a.endStr}, i.addEvent(t))
                        })
                    },
                    editable: !0,
                    events: [{title: "All Day Event", start: new Date(a, n, 1), className: "event-default"}, {
                        id: 999,
        ...
        var t = {
            columnDefs: [{field: "athlete", minWidth: 150, sortable: !0, filter: !0}, {
                field: "age",
                maxWidth: 90,
                sortable: !0,
                filter: !0
        ...
        am4core.ready(function () {
            ...
            e.radius = 3, e.propertyFields.fill = "color", e.events.on("inited", function (e) {
                !function t(e) {
                    e = e.animate([{property: "scale", from: 1, to: 5}, {
                        property: "opacity",
                        from: 1,
                        to: 0
            ...
            t.data = [{title: "Brussels", latitude: 50.8371, longitude: 4.3676, color: e.next()}, {
                title: "Copenhagen",
                latitude: 55.6763,
                longitude: 12.5681,
                color: e.next()
        ...
        if ("basic" == e) Swal.fire("Any fool can use a computer"); else if ("title-and-text" == e) Swal.mixin({
            customClass: {
        ...
        }); else if ("success-message" == e) Swal.fire("Good job!", "You clicked the button!", "success"); else if ("warning-message-and-confirmation" == e) {
            const t = Swal.mixin({
                customClass: {
                    confirmButton: "btn bg-gradient-success",
                    cancelButton: "btn bg-gradient-danger"
